const localizations = {
  ...
  'TAX': 'IVA',
  'Sorry transaction failed': 'Error en la transacción',
  'Subscription successful': 'Suscripción correcta',
  'Started secure transaction please complete process in the new window after you click continue': 'Inicio de la transacción segura. Complete el proceso haciendo clic en continuar',
  'Sorry, no 3DS link to complete the transaction': 'Lo sentimos, no hay vínculo seguro 3DS para completar la transacción',
  'Map': 'Mapa',
  'Version': 'Versión',
  'You are redirected to complete the 3DS secure transaction. If you want the transaction to complete continue to the following page and come back when done': 'Se redirigirá para completar la transacción segura 3DS. Si desea que la transacción se complete, continúe en la siguiente página y vuelva cuando termine',
  '3DS Transaction': 'Transacción segura 3DS',
  'Continue': 'Seguir',
  'Skip': 'Saltar',
  'Sorry, no QR code image found': 'Lo sentimos, no tiene ningun código QR',
  ...
  'I have donated to a charity with IWantToHelp http://web.iwanttohelp.org.uk #IWantToHelp': 'Acabo de hacer un donativo con YoQuieroAyudar http://web.microhuchasolidaria.org/ #YoQuieroAyudar',
  'fundraising,user,widget,IWantToHelp': 'fundraising,user,widget,YoQuieroAyudar',
  ...
  'Are you sure to logout and register new establishment?': 'Esta seguro/a de cerrar la sesión y crear un nuevo establecimiento solidario?',
  'Cancel': 'Cancelar',
  'Admin': 'Admin',
  ...
  'Add': 'Añadir',
  'Update': 'Actualizar',
  'All Associations': 'Todos',
  'Add New Association': 'Añadir nuevo organismo',
  'Update Associations.': 'Actualizar organismo',
  'Association name': 'Nombre organismo',
  'description': 'descripción',
  'Logo URL': 'URL logo',
  'Twitter Username': 'Cuenta twitter',
  'IBAN': 'IBAN',
  'BIC': 'BIC',
  'Association registration failed, please try again': 'Se ha producido un error al registrar la asociación. Inténtelo de nuevo',
  'Association registration successful': 'Registro de la asociación con éxito',
  'Register': 'Registro'
}
